...
class BinaryDSCLoss(torch.nn.Module):
    r"""
    Creates a criterion that optimizes a Binary-class Self-adjusting Dice Loss
    ...
    Shape:
        - logits: `(*)` where * means any number of dimensions.
        - targets: `(*)` same shape as the input.
    """
